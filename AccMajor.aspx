<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="AccMajor.aspx.cs" Inherits="Payroll.Views.AccMajor" %>
                    ...
                    <div class="col-lg-12 ">
                         <%------------------------------------------------- Detaisls Grid View -------------------------------------------------%>
                                <div class="table-responsive rounded-corners"> <%--PageSize="12"--%>
                                    ...
                                    <asp:GridView ID="gvView" runat="server"  AutoGenerateColumns="false" Width="100%" DataKeyNames="ACC_MAJ_CODE" CssClass="table  table-hover table-striped table-bordered table-responsive "
                                       ...
                                       <Columns>
                                            <asp:TemplateField HeaderText="View">
                                                <ItemStyle Width="3%" />
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="ImgBtnView" CommandName="detail" ToolTip="View Details" CommandArgument='<%#Eval("ACC_MAJ_CODE") %>' ImageUrl="~/Attachment/DefaultPhoto/View.ico" runat="server" Width="25" Height="20px" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Edit">
                                                <ItemStyle Width="3%" Height="10px" />
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="ImgBtnEdit" CommandName="editRecord" ToolTip="Edit" CommandArgument='<%#Eval("ACC_MAJ_CODE") %>' ImageUrl="~/Attachment/DefaultPhoto/Edit.ico" runat="server" Width="25" Height="20px" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Del">
                                                <ItemStyle Width="3%" />
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="ImgBtnDelete" CommandName="deleteRecord" ToolTip="Delete" CommandArgument='<%#Eval("ACC_MAJ_CODE") %>' ImageUrl="~/Attachment/DefaultPhoto/delete.ico" runat="server" Width="25" Height="20px" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            
                                           <asp:BoundField DataField="ACC_MAJ_CODE" ItemStyle-Width="20%" HeaderText="CODE" ItemStyle-Height="8px"  />
                                            <asp:BoundField DataField="ACC_MAJ_DESC" ItemStyle-Width="20%" ItemStyle-Height="8px" HeaderText="DESCRIPTION" />
   ...
   <div class="row">
        <div class="col-lg-2 "></div>
            ...
            <asp:Panel ID="panelAddEdit" runat="server" BorderStyle="None" Height="100%" Visible="false" Width="100%" BackColor="White" >
                <table class="table table-bordered table-hover table-responsive">
                    <tr>
                        <td> ACCOUNT MAJOR TYPE</td>
                        <td>
                            
                                <asp:TextBox ID="txtMajType" class="form-control" runat="server" Width="80%"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="rfvtxtDesc" runat="server" ValidationGroup="vgAdd" ControlToValidate="txtDesc" Display="None" SetFocusOnError="true" ErrorMessage="Enter Major Description"></asp:RequiredFieldValidator>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <asp:DetailsView ID="dvLookup" runat="server" CssClass="table table-bordered table-hover" BackColor="White" ForeColor="Black" FieldHeaderStyle-Wrap="false" FieldHeaderStyle-Font-Bold="true" FieldHeaderStyle-BackColor="LavenderBlush" FieldHeaderStyle-ForeColor="Black" BorderStyle="Groove" AutoGenerateRows="False">
                            <Fields>
                                ...
                                <asp:BoundField DataField="ACC_MAJ_TYPE" HeaderText="ACCOUNT MAJOR TYPE" />
                                <asp:BoundField DataField="ACC_MAJ_CODE" HeaderText="CODE" />
                                 <asp:BoundField DataField="ACC_MAJ_DESC" HeaderText="DESCRIPTION" />
