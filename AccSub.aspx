<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="AccSub.aspx.cs" Inherits="Payroll.Views.AccSub" %>
                    ...
                    <div class="col-lg-12 ">
                         <%------------------------------------------------- Detaisls Grid View -------------------------------------------------%>
                                <div class="table-responsive rounded-corners"> <%--PageSize="12"--%>
                                    ...
                                    <asp:GridView ID="gvView" runat="server"  AutoGenerateColumns="false" Width="100%" DataKeyNames="SUBGRP_CODE" CssClass="table  table-hover table-striped table-bordered table-responsive "
                                       ...
                                       <Columns>
                                            <asp:TemplateField HeaderText="View">
                                                <ItemStyle Width="3%" />
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="ImgBtnView" CommandName="detail" ToolTip="View Details" CommandArgument='<%#Eval("SUBGRP_CODE") %>' ImageUrl="~/Attachment/DefaultPhoto/View.ico" runat="server" Width="25" Height="20px" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Edit">
                                                <ItemStyle Width="3%" Height="10px" />
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="ImgBtnEdit" CommandName="editRecord" ToolTip="Edit" CommandArgument='<%#Eval("SUBGRP_CODE") %>' ImageUrl="~/Attachment/DefaultPhoto/Edit.ico" runat="server" Width="25" Height="20px" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Del">
                                                <ItemStyle Width="3%" />
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="ImgBtnDelete" CommandName="deleteRecord" ToolTip="Delete" CommandArgument='<%#Eval("SUBGRP_CODE") %>' ImageUrl="~/Attachment/DefaultPhoto/delete.ico" runat="server" Width="25" Height="20px" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            
                                          <%-- <asp:BoundField DataField="SUBGRP_MINCODE" ItemStyle-Width="20%" HeaderText="CODE" ItemStyle-Height="8px" visible="false" />--%>
                                            <asp:BoundField DataField="SUBGRP_CODE" ItemStyle-Width="20%" ItemStyle-Height="8px" HeaderText="CODE" />
                                            <asp:BoundField DataField="SUBGRP_DESC" ItemStyle-Width="20%" ItemStyle-Height="8px" HeaderText="Description" />
                ...
                <table class="table table-bordered table-hover table-responsive">
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:DropDownList ID="ddlMinCode" runat="server" CssClass="form-control" DataValueField="MIN_CODE" DataTextField="MIN_DESC" ></asp:DropDownList>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <asp:DetailsView ID="dvLookup" runat="server" CssClass="table table-bordered table-hover" BackColor="White" ForeColor="Black" FieldHeaderStyle-Wrap="false" FieldHeaderStyle-Font-Bold="true" FieldHeaderStyle-BackColor="LavenderBlush" FieldHeaderStyle-ForeColor="Black" BorderStyle="Groove" AutoGenerateRows="False">
                            <Fields>
                                ...
                                <asp:BoundField DataField="SUBGRP_MINCODE" HeaderText="MINOR CODE" />
                                <asp:BoundField DataField="SUBGRP_CODE" HeaderText="CODE" />
                                 <asp:BoundField DataField="SUBGRP_DESC" HeaderText="DESCRIPTION" />
